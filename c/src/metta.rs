...
/// @note The returned `atom_t` must be freed with `atom_free()`
///
#[no_mangle] pub extern "C" fn ATOM_TYPE_NUMBER() -> atom_t { hyperon_atom::number::ATOM_TYPE_NUMBER.into() }
...
/// @note The returned `atom_t` must be freed with `atom_free()`
///
#[no_mangle] pub extern "C" fn ATOM_TYPE_BOOL() -> atom_t { hyperon_atom::bool::ATOM_TYPE_BOOL.into() }
