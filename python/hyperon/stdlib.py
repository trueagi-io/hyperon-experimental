...
def get_py_atom(path, unwrap=True, typ=AtomType.UNDEFINED, mod=None):
...
def do_py_dot(mod, path, unwrap=True, typ=AtomType.UNDEFINED):
    return get_py_atom(path, unwrap, typ, mod)
