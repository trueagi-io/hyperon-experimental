...
pub fn register_common_tokens(tref: &mut Tokenizer, _tokenizer: Shared<Tokenizer>, space: &DynSpace, metta: &Metta) {
    ...
    let get_type_op = Atom::gnd(stdlib_common_tokens::GetTypeOp::new(space.clone()));
    tref.register_token(regex(r"get-type"), move |_| { get_type_op.clone() });
    let get_type_space_op = Atom::gnd(stdlib_common_tokens::GetTypeSpaceOp{});
    tref.register_token(regex(r"get-type-space"), move |_| { get_type_space_op.clone() });
    let get_meta_type_op = Atom::gnd(stdlib_common_tokens::GetMetaTypeOp{});
    tref.register_token(regex(r"get-metatype"), move |_| { get_meta_type_op.clone() });
    let is_equivalent = Atom::gnd(stdlib_common_tokens::IfEqualOp{});
    tref.register_token(regex(r"if-equal"), move |_| { is_equivalent.clone() });
    let new_space_op = Atom::gnd(stdlib_common_tokens::NewSpaceOp{});
    tref.register_token(regex(r"new-space"), move |_| { new_space_op.clone() });
    let add_atom_op = Atom::gnd(stdlib_common_tokens::AddAtomOp{});
    tref.register_token(regex(r"add-atom"), move |_| { add_atom_op.clone() });
    let remove_atom_op = Atom::gnd(stdlib_common_tokens::RemoveAtomOp{});
    tref.register_token(regex(r"remove-atom"), move |_| { remove_atom_op.clone() });
    let get_atoms_op = Atom::gnd(stdlib_common_tokens::GetAtomsOp{});
    tref.register_token(regex(r"get-atoms"), move |_| { get_atoms_op.clone() });
    let new_state_op = Atom::gnd(stdlib_common_tokens::NewStateOp{});
    tref.register_token(regex(r"new-state"), move |_| { new_state_op.clone() });
    let change_state_op = Atom::gnd(stdlib_common_tokens::ChangeStateOp{});
    tref.register_token(regex(r"change-state!"), move |_| { change_state_op.clone() });
    let get_state_op = Atom::gnd(stdlib_common_tokens::GetStateOp{});
    tref.register_token(regex(r"get-state"), move |_| { get_state_op.clone() });
    let nop_op = Atom::gnd(stdlib_common_tokens::NopOp{});
    tref.register_token(regex(r"nop"), move |_| { nop_op.clone() });
    let match_op = Atom::gnd(stdlib_common_tokens::MatchOp{});
    tref.register_token(regex(r"match"), move |_| { match_op.clone() });
    let min_atom_op = Atom::gnd(stdlib_common_tokens::MinAtomOp{});
    tref.register_token(regex(r"min-atom"), move |_| { min_atom_op.clone() });
    let max_atom_op = Atom::gnd(stdlib_common_tokens::MaxAtomOp{});
    tref.register_token(regex(r"max-atom"), move |_| { max_atom_op.clone() });
    let size_atom_op = Atom::gnd(stdlib_common_tokens::SizeAtomOp{});
    tref.register_token(regex(r"size-atom"), move |_| { size_atom_op.clone() });
    let index_atom_op = Atom::gnd(stdlib_common_tokens::IndexAtomOp{});
    ...
    let mod_space_op = Atom::gnd(stdlib_common_tokens::ModSpaceOp::new(metta.clone()));
    tref.register_token(regex(r"mod-space!"), move |_| { mod_space_op.clone() });
    let print_mods_op = Atom::gnd(stdlib_common_tokens::PrintModsOp::new(metta.clone()));
    tref.register_token(regex(r"print-mods!"), move |_| { print_mods_op.clone() });
    let unique_op = Atom::gnd(stdlib_common_tokens::UniqueAtomOp{});
    tref.register_token(regex(r"unique-atom"), move |_| { unique_op.clone() });
    let subtraction_op = Atom::gnd(stdlib_common_tokens::SubtractionAtomOp{});
    tref.register_token(regex(r"subtraction-atom"), move |_| { subtraction_op.clone() });
    let intersection_op = Atom::gnd(stdlib_common_tokens::IntersectionAtomOp{});
    tref.register_token(regex(r"intersection-atom"), move |_| { intersection_op.clone() });
    let union_op = Atom::gnd(stdlib_common_tokens::UnionAtomOp{});
...
pub fn register_runner_tokens(tref: &mut Tokenizer, tokenizer: Shared<Tokenizer>, space: &DynSpace, metta: &Metta) {
    ...
    let assert_equal_op = Atom::gnd(stdlib_runner_tokens::AssertEqualOp::new(space.clone()));
    tref.register_token(regex(r"assertEqual"), move |_| { assert_equal_op.clone() });
    let assert_equal_to_result_op = Atom::gnd(stdlib_runner_tokens::AssertEqualToResultOp::new(space.clone()));
    tref.register_token(regex(r"assertEqualToResult"), move |_| { assert_equal_to_result_op.clone() });
    let superpose_op = Atom::gnd(stdlib_runner_tokens::SuperposeOp::new(space.clone()));
    tref.register_token(regex(r"superpose"), move |_| { superpose_op.clone() });
    let collapse_op = Atom::gnd(stdlib_runner_tokens::CollapseOp::new(space.clone()));
    tref.register_token(regex(r"collapse"), move |_| { collapse_op.clone() });
    let case_op = Atom::gnd(stdlib_runner_tokens::CaseOp::new(space.clone()));
    tref.register_token(regex(r"case"), move |_| { case_op.clone() });
    let capture_op = Atom::gnd(stdlib_runner_tokens::CaptureOp::new(space.clone()));
    tref.register_token(regex(r"capture"), move |_| { capture_op.clone() });
    let pragma_op = Atom::gnd(stdlib_runner_tokens::PragmaOp::new(metta.settings().clone()));
    tref.register_token(regex(r"pragma!"), move |_| { pragma_op.clone() });
    let import_op = Atom::gnd(stdlib_runner_tokens::ImportOp::new(metta.clone()));
    tref.register_token(regex(r"import!"), move |_| { import_op.clone() });
    let include_op = Atom::gnd(stdlib_runner_tokens::IncludeOp::new(metta.clone()));
    tref.register_token(regex(r"include"), move |_| { include_op.clone() });
    let bind_op = Atom::gnd(stdlib_runner_tokens::BindOp::new(tokenizer.clone()));
    tref.register_token(regex(r"bind!"), move |_| { bind_op.clone() });
    let trace_op = Atom::gnd(stdlib_runner_tokens::TraceOp{});
    tref.register_token(regex(r"trace!"), move |_| { trace_op.clone() });
    let println_op = Atom::gnd(stdlib_runner_tokens::PrintlnOp{});
    tref.register_token(regex(r"println!"), move |_| { println_op.clone() });
    let format_args_op = Atom::gnd(stdlib_runner_tokens::FormatArgsOp{});
    tref.register_token(regex(r"format-args"), move |_| { format_args_op.clone() });
    let print_alternatives_op = Atom::gnd(stdlib_runner_tokens::PrintAlternativesOp{});
    tref.register_token(regex(r"print-alternatives!"), move |_| { print_alternatives_op.clone() });
    let sealed_op = Atom::gnd(stdlib_runner_tokens::SealedOp{});
